...
function mailerConnection({toUser, from}) {
    ...
    const message ={
        ...
        to: toUser.email,
        subject:"Pilih Partner - "+from.name+" Send You Connection Request!",
        html:`
            ...
            <p>You have a new connection request, please response it from our website</p>
            <p></p>
            <p>Cheers,</p>
            <p>PilihPartner.id</p>
        `
...
export default mailerConnection